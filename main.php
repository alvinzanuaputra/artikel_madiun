...
if (!isLoggedIn()) {
    ...
    $_SESSION['toast_message'] = 'Anda harus login terlebih dahulu untuk mengakses halaman ini.';
        ...
        <form method="GET" action="" class="search-filter-container">
            ...
            <div class="category-filter">
                ...
                <?php if (!empty($search) || !empty($selectedCategory)): ?>
                    <a href="main.php" class="clear-filters">
    ...
    <div class="blog-container">
        ...
        <?php else: ?>
            ...
            <div class="no-results">
                ...
                <a href="main.php" class="btn">Lihat Semua Artikel</a>
            </div>
        <?php endif; ?>
    </div>
