...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($login) || empty($password)) {
        ...
        if ($user) {
            ...
            $_SESSION['login_time'] = time(); // Set waktu login untuk referensi

            // Tambahkan pesan toast
            $_SESSION['toast_message'] = 'Login berhasil. Selamat datang, ' . htmlspecialchars($user['nickname']) . '! Session berlaku selama 1 jam.';
